...
// Dolaczamy modul obliczen 300+ parametrow z surowych danych
#include "apiary_collector_computation.h"
...
public:
    ...
    // ============================================================================
    // Funkcja computeParametersFromRaw() została przeniesiona do apiary_collector_computation.h
    // Używamy wersji inline z nagłówka, aby uniknąć duplikacji kodu
    at>(data.vibration_raw) / 1024.0f;
